...
\begin{document}
    ...
    \tagline{DIGITALISATION DES PROCESSUS \& ANALYSE FONCTIONNELLE SI}
    ...
    \begin{quote}
    \normalsize Ingénieur logiciel (Master 2 en Système d'Information et Génie Logiciel) avec plus de 5 ans d'expérience dans l'analyse et la digitalisation de processus métiers. Expert Informatique pour l'Organisation Internationale de la Francophonie et Architecte technique pour l'Université Senghor, j'interviens du recueil des besoins et de la rédaction des spécifications fonctionnelles jusqu'au déploiement, en passant par la recette (UAT) et le suivi des anomalies. Passerelle entre les utilisateurs et les équipes techniques, je conduis l'automatisation, la dématérialisation et l'amélioration continue des processus, et j'accompagne les directions métiers dans l'appropriation des nouveaux outils (formateur ESATIC, Orange, RMO).
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            \textbf{Analyse fonctionnelle \& processus} \\[0.3em]
            \cvtag{Expression des besoins}
            \cvtag{Spécifications fonctionnelles}
            \cvtag{Modélisation UML}
            \cvtag{Urbanisation SI}
            \vspace{0.5em}

            \textbf{Digitalisation \& automatisation} \\[0.3em]
            \cvtag{Digitalisation de processus}
            \cvtag{Dématérialisation}
            \cvtag{Automatisation}
            \cvtag{Intégration continue}
            \cvtag{API REST}
            \vspace{0.5em}

            \textbf{Recette \& qualité} \\[0.3em]
            \cvtag{Tests utilisateurs (UAT)}
            \cvtag{Squash-TM}
            \cvtag{Mantis}
            \cvtag{Selenium}
            \vspace{0.5em}

            \textbf{Conduite du changement} \\[0.3em]
            \cvtag{Accompagnement métier}
            \cvtag{Formation}
            \cvtag{Adoption des outils}
            \vspace{0.5em}

            \textbf{Gestion de projet \& SI} \\[0.3em]
            \cvtag{Suivi de projet}
            \cvtag{Gouvernance des données}
            \cvtag{RBAC}
            \vspace{0.5em}

            \textbf{Outils \& développement} \\[0.3em]
        ...
        \cvsection{Points forts}
            \cvachievement{}{Digitalisation \& dématérialisation de processus}{Du besoin métier à la mise en production}
            \cvachievement{}{Institutions publiques \& internationales}{OIF, Université Senghor, ESATIC, ANSUT}
            \cvachievement{}{Conduite du changement \& formation}{ESATIC, Orange, RMO}
        ...
        \cvsection{Expériences}
            ...
            \begin{itemize}
                ...
                \item Recueil et formalisation des besoins métier, rédaction des spécifications fonctionnelles et passerelle entre les utilisateurs et l'équipe technique.
                \item Digitalisation et automatisation de processus métiers (gestion des activités du Pavillon lors des COP).
                ...
                \item Recette et vérification de la conformité aux spécifications fonctionnelles avant chaque mise en production ; suivi des anomalies.
                \item Accompagnement des équipes métier et appui à l'adoption des outils (conduite du changement).
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} Python, Laravel, VueJs, Supabase, API REST.
            \end{itemize}
            \divider

            \cvevent{Architecte Technique \& Développeur Full Stack}{Université Senghor — Université internationale de langue française, Opérateur direct de la Francophonie}{Décembre 2025 -- Décembre 2026}{Alexandrie, Égypte (Télétravail)}
            \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Automatisation de tests (Python, Selenium IDE), recette et conseil aux équipes de développement (suivi des anomalies).
            ...
            \cvevent{Formateur Python}{RMO Capital Humain}{Août 2025 \textnormal{(5 jours)}}{Abidjan, Côte d'Ivoire}
            \begin{itemize}
            ...
            \cvevent{Formateur Flutter}{Orange Côte d'Ivoire}{Avril 2023 \textnormal{(5 jours)}}{Abidjan, Côte d'Ivoire}
            \begin{itemize}
