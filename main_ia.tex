...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Points forts}
            ...
            \cvachievement{}{Finaliste Hackathon Francophone IA}{ESG Mefali — Top 10/200}
        % ----- POINTS FORTS -----
        ...
        \cvsection{Expériences}
            ...
            \begin{itemize}
                \item Plateforme en production : \cvreference{epavillonclimatique.francophonie.org}{https://epavillonclimatique.francophonie.org/} (gestion des activités du Pavillon de la Francophonie lors des COP pour les 53 États membres).
            ...
            \begin{itemize}
                ...
                \item Conception de l'architecture technique du site institutionnel trilingue (FR/EN/AR, RTL) : monorepo Nuxt 4 (SSR) + FastAPI, urbanisation en 12 services fonctionnels (\textasciitilde65 tables PostgreSQL).
        ...
        \cvsection{Projets notables}
            \cvevent{ESG Mefali — Conseiller ESG IA \textnormal{\textit{(Finaliste Hackathon Francophone IA)}}}{IFDD, Fondation Green Open Lab \& Gouvernement du Québec}{Mars 2026}{}
            \begin{itemize}
