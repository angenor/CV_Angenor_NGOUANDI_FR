...
%% Variante du CV adaptée au poste de Directeur des Systèmes d'Information (DSI)
...
\begin{document}
    ...
    \tagline{SYSTÈMES D'INFORMATION | ARCHITECTURE, GOUVERNANCE SI \& TRANSFORMATION DIGITALE}
    ...
    \begin{quote}
    \normalsize Ingénieur en systèmes d'information (Master 2 en Système d'Information et Génie Logiciel) avec plus de 5 ans d'expérience en conception et pilotage d'architectures SI, sécurisation des données et conduite de projets de transformation digitale. Expert Informatique pour l'Organisation Internationale de la Francophonie et architecte technique pour l'Université Senghor, où j'ai urbanisé un système d'information institutionnel (\textasciitilde65 tables, gouvernance RBAC, sécurité JWT/SSL, infrastructure Docker/Nginx). Expérience confirmée auprès d'institutions publiques et internationales, doublée d'une activité de formateur (ESATIC, Orange, RMO) orientée vers le renforcement des capacités et l'accompagnement des utilisateurs.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            \textbf{Architecture \& Systèmes d'Information} \\[0.3em]
            ...
            \textbf{Sécurité \& Gouvernance SI} \\[0.3em]
            \cvtag{JWT}
            \cvtag{SSL/TLS}
            \cvtag{RBAC}
            ...
            \textbf{Infrastructure / Outils} \\[0.3em]
            \cvtag{Docker}
            \cvtag{Nginx}
            \cvtag{Linux}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Architecture \& urbanisation SI}{\textasciitilde65 tables, 12 services, gouvernance RBAC}
            \cvachievement{}{Sécurité \& infrastructure de production}{JWT, SSL/TLS, Docker, Nginx}
        ...
        \cvsection{Expériences}
            ...
            \begin{itemize}
                ...
                \item Conception de l'architecture technique et urbanisation d'un système d'information institutionnel trilingue (FR/EN/AR, RTL) : monorepo Nuxt 4 (SSR) + FastAPI, 12 services fonctionnels (\textasciitilde65 tables PostgreSQL).
                ...
                \item Sécurisation et infrastructure de production : Docker Compose, Nginx (reverse proxy, SSL/TLS, rate limiting), déploiement automatisé, authentification JWT + refresh tokens, en-têtes HTTP sécurisés.
                \item Volumétrie livrée : 70+ pages, 135 composants Vue, 51 endpoints API, 15 services métier.
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} Nuxt 4, Vue 3, FastAPI, Python, SQLAlchemy 2 (async), PostgreSQL 16, Docker, Nginx.
            \end{itemize}
            \divider
            ...
            \begin{itemize}
                ...
                \item Conception, développement et maintenance corrective et évolutive des systèmes d'information de l'institution.
