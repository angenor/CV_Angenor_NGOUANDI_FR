...
\begin{document}
    ...
    \begin{quote}
    \normalsize Développeur Full Stack avec plus de 5 ans d'expérience, spécialisé en développement web (Laravel, FastAPI, VueJs) et mobile (Flutter), Consultant pour l'Organisation Internationale de la Francophonie, formateur technique (Orange CI, RMO, ESATIC) et passionné par l'IA appliquée.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Consultant OIF}{5 COP depuis 2021}
            \cvachievement{}{Formateur}{Orange CI, RMO, ESATIC}
            \cvachievement{}{IA appliquée}{Chatbot IA}
        % ----- POINTS FORTS -----
