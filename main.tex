...
\begin{document}
    ...
    \tagline{INNOVATION \& INTELLIGENCE ARTIFICIELLE | RENFORCEMENT DES CAPACITÉS NUMÉRIQUES}
    ...
    \begin{quote}
    \normalsize Ingénieur logiciel (Master 2 en Système d'Information et Génie Logiciel) avec plus de 5 ans d'expérience, spécialisé en innovation technologique, intelligence artificielle et renforcement des capacités numériques. Concepteur de solutions d'IA (plateforme conversationnelle, agents LLM, RAG) et finaliste du Hackathon Francophone IA. Expert Informatique pour l'Organisation Internationale de la Francophonie et consultant pour l'Université Senghor, avec une solide expérience auprès d'institutions publiques et internationales. Formateur technique (ESATIC, Orange, RMO) engagé dans le transfert de compétences et la montée en compétences des équipes.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            \textbf{Intelligence Artificielle} \\[0.3em]
            \cvtag{Agents LLM}
            \cvtag{Claude API}
            \cvtag{LangGraph}
            \cvtag{LangChain}
        ...
        % ----- INTERETS -----
        \cvsection{Intérêts}
            \cvtag{Innovation technologique}
            \cvtag{Renforcement des capacités}
            \cvtag{Pédagogie}
