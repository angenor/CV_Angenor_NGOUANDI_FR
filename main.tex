...
\begin{document}
    ...
    \tagline{DÉVELOPPEUR D'APPLICATIONS WEB \& MOBILE | FULL STACK}
    ...
    \begin{quote}
    \normalsize Développeur d'applications web et mobile avec plus de 5 ans d'expérience dans la conception et le développement d'applications métier : analyse des besoins utilisateurs, conception de solutions adaptées, contribution à l'architecture technique, développement full-stack et mobile, optimisation des performances, sécurité, tests et recette, déploiement (Docker), puis support et maintenance corrective et évolutive. Plus de 5 plateformes développées et mises en production auprès d'institutions publiques et internationales (Organisation Internationale de la Francophonie, Université Senghor). Master 2 en Système d'Information et Génie Logiciel (BAC+5).
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            ...
            \textbf{Développement mobile} \\[0.3em]
            \cvtag{Flutter}
            \cvtag{Android / iOS}
            \vspace{0.5em}
            ...
            \cvtag{Firebase}
            \cvtag{ETL}
            \cvtag{Reporting / tableaux de bord}
            \vspace{0.5em}

            \textbf{Sécurité \& support} \\[0.3em]
            \cvtag{Sécurité applicative}
            \cvtag{JWT / OWASP}
            \cvtag{Support applicatif}
            \cvtag{Optimisation des performances}
            \vspace{0.5em}
            ...
            \textbf{Méthodes \& gestion de projet} \\[0.3em]
            \cvtag{Agile / Scrum}
            \cvtag{Cycle en V}
            \cvtag{ITIL}
            \cvtag{COBIT}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Applications en production}{5+ plateformes développées}
            \cvachievement{}{Cycle complet de développement}{Cahier des charges, dev, tests, formation, maintenance}
        ...
        \cvsection{Intérêts}
            ...
            \cvtag{Pédagogie}
            \cvtag{Bricolage électromécanique}
        % ----- INTERETS -----
        ...
        \cvsection{Expériences}
            ...
            \cvevent{Développeur Full Stack \& Expert Informatique}{Organisation Internationale de la Francophonie - Institut de la Francophonie pour le Développement Durable}{Mai 2021 -- En cours(Fini en Déc. 2027)}{Québec, Canada (Télétravail)}
            \begin{itemize}
                ...
                \item Développement de l'application mobile \textbf{Guide du Négociateur Francophone} (Android/iOS, Flutter) : outil d'aide aux négociateurs climatiques de la Francophonie lors des COP.
                ...
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} Python, Laravel, VueJs, Supabase, Flutter (Android/iOS), API REST.
            \end{itemize}
            \divider

            \cvevent{Développeur Full Stack \& Chef de projet (consultant)}{Université Senghor — Université internationale de langue française, Opérateur direct de la Francophonie}{Décembre 2025 -- Décembre 2026}{Alexandrie, Égypte (Télétravail)}
            \begin{itemize}
                ...
                \item Définition et pilotage du modèle de gouvernance SI multi-acteurs pour l'administration décentralisée par les équipes des \textbf{14 pays} de représentation (RBAC, périmètres de contribution, journal d'audit).
            ...
            \cvevent{Formateur technique ponctuel}{RMO Capital Humain \& Orange CI}{2023 -- 2026}{Abidjan, Côte d'Ivoire}
            \begin{itemize}
        ...
        % ----- PROJETS -----
        \cvsection{Autres projets notables}
