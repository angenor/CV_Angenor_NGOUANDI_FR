...
\begin{document}
    ...
    \tagline{INGÉNIEUR DÉVELOPPEUR D'APPLICATIONS FULL STACK}
    ...
    \begin{quote}
    \normalsize Ingénieur logiciel (Master 2 Système d'Information et Génie Logiciel) avec plus de 5 ans d'expérience en développement, intégration et maintenance d'applications métier. Conception et développement d'API REST et d'interfaces d'échange avec des systèmes tiers, définition des choix techniques, mise en place de plateformes de tests et d'intégration continue, développement sécurisé et accompagnement des utilisateurs. Expert Informatique pour l'Organisation Internationale de la Francophonie, architecte technique et développeur full stack pour l'Université Senghor, enseignant vacataire en développement sécurisé et audit de code, avec plus de 5 plateformes en production.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            ...
            \cvtag{Python/FastAPI}
            \cvtag{ PHP/ Laravel}
            \cvtag{VueJs / Nuxt}
            \cvtag{Flutter}
            \vspace{0.5em}

            \textbf{API \& intégration} \\[0.3em]
            \cvtag{API REST}
            \cvtag{Services web}
            \cvtag{Intégration d'API tierces}
            \cvtag{ETL}
            ...
            \textbf{Qualité, tests \& sécurité} \\[0.3em]
        ...
        \cvsection{Points forts}
            \cvachievement{}{Développement \& intégration d'applications}{5+ ans, 5 plateformes en production}
            \cvachievement{}{API REST \& interfaces avec systèmes tiers}{Conception, développement, maintenance}
        ...
        \cvsection{Expériences}
            ...
            \cvevent{Expert Informatique}{Organisation Internationale de la Francophonie - Institut de la Francophonie pour le Développement Durable}{Mai 2021 -- En cours}{Québec, Canada (Télétravail)}
            \begin{itemize}
                ...
                \item Analyse des besoins fonctionnels et techniques exprimés par les équipes métier ; définition de l'architecture technique et des choix technologiques de la plateforme.
                \item Conception, développement et maintenance corrective et évolutive des applications de l'institution.
                \item Développement d'API REST et d'interfaces d'échange avec des systèmes externes (Zoom, YouTube, OpenRouter) ; analyse des impacts techniques des nouvelles solutions.
                ...
                \item Support aux équipes métier lors des phases de recette, suivi et correction des anomalies applicatives.
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} Python, Laravel, VueJs, Supabase, Flutter, API REST.
            \end{itemize}
            \divider

            \cvevent{Architecte Technique \& Développeur Full Stack}{Université Senghor}{Décembre 2025 -- Décembre 2026}{Alexandrie, Égypte (Télétravail)}
            \begin{itemize}
                ...
                \item Développement sécurisé et mise en production : Docker Compose, Nginx (reverse proxy, SSL/TLS, rate limiting), déploiement automatisé, authentification JWT + refresh tokens, en-têtes HTTP sécurisés.
                \item Développement et documentation de \textbf{51 endpoints API REST} consommés par le front SSR et les back-offices ; volumétrie livrée : 70+ pages, 135 composants Vue, 15 services métier.
            ...
            \begin{itemize}
                ...
                \item Enseignement des processus \textbf{ETL} (extraction, transformation, chargement) et de l'intégration de données.
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} HTML, CSS, PHP, Javascript, UML, FastAPI, SQL, ETL
            \end{itemize}
            \divider
        ...
        \begin{itemize}
            ...
            \item Automatisation de tests via Python et Selenium IDE ; suivi et qualification des anomalies, conseil aux équipes de développement.
