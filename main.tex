...
\begin{document}
    ...
    \begin{quote}
    \normalsize Développeur Full Stack avec plus de 5 ans d'expérience, spécialisé en développement mobile (Flutter) et web (Laravel, VueJs). Consultant pour l'Organisation Internationale de la Francophonie, formateur technique (Orange CI, RMO, ESATIC) et passionné par l'IA appliquée.
    \end{quote}
    \vspace{-0.5em}
