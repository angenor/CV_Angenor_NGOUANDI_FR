...
\begin{document}
    ...
    \tagline{DÉVELOPPEUR FULL STACK | IA APPLIQUÉE}
    ...
    \begin{quote}
    \normalsize Développeur Full Stack avec plus de 5 ans d'expérience en développement web et mobile et passionné par l'Intelligence Artificielle appliquée. Expérience concrète en Machine Learning (NLP, classification) et en développement de chatbot IA. Consultant pour l'Organisation Internationale de la Francophonie et formateur technique.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Chatbot IA}{Gemini API, NLP}
            \cvachievement{}{Machine Learning}{Classification, NLP}
        ...
        \cvsection{Expériences}
            ...
            \begin{itemize}
                ...
                \item Conception et développement d'un chatbot intelligent intégrant l'API Gemini 2.5 Flash (LLM/Transformer) pour fournir une assistance automatisée aux visiteurs et assister les négociateurs francophones.
                ...
                \item \textcolor{SecondaryColor}{\textbf{Outils: }} Python, Gemini API, ElevenLabs API, Flutter, Laravel, VueJs, Supabase, Claude Code.
            \end{itemize}
            \divider
