...
\begin{document}
    ...
    \begin{quote}
    \normalsize Développeur d'applications web et mobile avec plus de 5 ans d'expérience dans la conception et le développement de produits digitaux : identification des besoins, participation au choix des solutions, rédaction de cahiers des charges, développement full-stack, tests et recette, suivi de projet, formation des utilisateurs et maintenance corrective et évolutive. Plus de 5 plateformes développées et mises en production auprès d'institutions publiques et internationales (Organisation Internationale de la Francophonie, Université Senghor). Pratique des approches Agile/Scrum, des référentiels ITIL/COBIT et veille technologique continue. Master 2 en Système d'Information et Génie Logiciel (BAC+5).
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Expériences}
            ...
            \cvevent{Formateur technique ponctuel}{RMO Capital Humain \& Orange CI}{2023 -- 2025}{Abidjan, Côte d'Ivoire}
            \begin{itemize}
