...
\begin{document}
    ...
    \tagline{ANALYSTE FONCTIONNEL SI | ARCHITECTURE \& GOUVERNANCE DES DONNÉES}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            ...
            \cvtag{Sélection de solutions SaaS}
            \cvtag{API REST}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Passerelle métier \& technique}{Recueil des besoins, processus, adoption}
            \cvachievement{}{Gouvernance des données \& architecture SI}{RBAC, conformité, audit, sécurité}
            \cvachievement{}{Opérateurs de la Francophonie}{OIF, Université Senghor, ESATIC, ANSUT}
        ...
        \cvsection{Expériences}
            ...
            \cvevent{Expert Informatique \textnormal{\textit{(Contrat d'expert)}}}{Organisation Internationale de la Francophonie - Institut de la Francophonie pour le Développement Durable}{Mai 2021 -- En cours(Fini en Déc. 2027)}{Québec, Canada (Télétravail)}
            \begin{itemize}
