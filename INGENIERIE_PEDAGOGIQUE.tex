...
\begin{document}
    ...
    \tagline{INGÉNIERIE PÉDAGOGIQUE \& PROJETS DE FORMATION | FORMATEUR EN INFORMATIQUE}
    ...
    \begin{quote}
    \normalsize Formateur et concepteur de formations en informatique avec plus de 5 ans d'expérience, intervenant aussi bien en milieu universitaire (ESATIC, Université Polytechnique de Bingerville) qu'en entreprise (Orange Côte d'Ivoire, RMO). Habitué à piloter des projets de A à Z — recueil des besoins, rédaction de cahiers des charges, conception pédagogique et animation —, je conçois et anime des parcours présentiels ainsi que des contenus web et multimédia. En parallèle, analyste fonctionnel et architecte SI pour l'écosystème de la Francophonie (OIF, Université Senghor), j'accompagne les équipes métier dans la prise en main et l'adoption des outils. Master 2 en Système d'Information et Génie Logiciel.
    \end{quote}
    \vspace{-0.5em}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{COMPÉTENCES}
            \textbf{Ingénierie \& animation pédagogique} \\[0.3em]
            \cvtag{Cahier des charges}
            \cvtag{Conception pédagogique}
            \cvtag{Animation de formation}
            \cvtag{Évaluation des acquis}
            \vspace{0.5em}

            \textbf{Pilotage de projets} \\[0.3em]
            ...
            \textbf{Contenus \& multimédia} \\[0.3em]
            \cvtag{Création de contenus web}
            \cvtag{Supports multimédia}
            \cvtag{Intégration vidéo}
            \vspace{0.5em}

            \textbf{Socle technique} \\[0.3em]
            \cvtag{Python}
            \cvtag{Laravel}
            \cvtag{VueJs}
            \cvtag{Flutter}
        ...
        \cvsection{Points forts}
            \cvachievement{}{Formateur \& enseignant}{Universités (ESATIC, UP Bingerville) \& entreprises (Orange, RMO)}
            \cvachievement{}{Pilotage de projets de A à Z}{Besoins, cahier des charges, conception, suivi}
            \cvachievement{}{Conception de contenus web \& multimédia}{Plateformes, supports, intégration vidéo}
